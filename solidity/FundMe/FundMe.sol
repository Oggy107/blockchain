...
contract FundMe {
    ...
    function fund() public payable {
        // we dont need to pass first argument to getConversionRate() method because it considers msg.value (here) as first argument
    ...
    // special functions (if someone sends currency to this contract wihout calling fund function then recieve function will be called automatically)

    // 1. receive
    // this functions is called when calldata is empty and it is assumed that only ether or currency is being sent to this contract
